      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            turn them off at any time through the cookie consent banner, and we delete the cookies
            when you do. Session recording (Microsoft Clarity) and marketing (Meta Pixel) never load
            without your explicit opt-in, anywhere in the world.
          </p>
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
