        ...
        <div>
          ...
          <ul className="list-inside list-disc space-y-[4px] pb-[1em]">
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              ...
              describes how consent works once analytics is enabled here. Google&apos;s tags set no
              analytics or advertising cookies and read no identifiers from your device until you
              accept through the cookie consent banner, wherever in the world you are — until then
              only aggregate, cookieless measurement takes place. Session recording (Microsoft
              Clarity) and marketing (Meta Pixel) load only after you opt in. You can withdraw
              consent at any time through the cookie consent banner; this site then deletes the
              tracking cookies it set, Google&apos;s tags return to the cookieless state, and
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            <a href="mailto:jwvpost619@gmail.com" className="text-[#0062CC] underline">
              jwvpost619@gmail.com
            </a>{' '}
            or (702) 884-4175 to exercise any of these rights; we will respond within the time
            limits the GDPR sets. You also have the right to lodge a complaint with your national
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            <strong>We do not sell or share your personal information.</strong> JWV Post 619 does
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            you accept, anywhere in the world; you can turn them off again at any time through the
            cookie consent banner, and we delete the cookies when you do. Session recording
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            or (702) 884-4175. We will verify your request using information associated with your
