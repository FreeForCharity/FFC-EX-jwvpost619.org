...
export const metadata: Metadata = {
  title: 'Terms of Service | JWV Post 619',
  description: 'Terms of Service for JWV Post 619 website',
}
    ...
    <div className="pt-[130px] pb-[54px]">
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Welcome to JWV Post 619! These Terms of Service (“Terms”) govern your access to and use
            of our website, services, and platforms (collectively, “Services”), provided by Free For
            Charity (“we,” “us,” or “our”). By accessing or using our Services, you agree to be
          ...
          <ul className="list-inside ml-[1.5em] space-y-[4px]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              Using the Services to solicit funds outside the scope of JWV Post 619’s mission.
            </li>
          </ul>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All donations made to JWV Post 619 are voluntary and non-refundable. By making a
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All payments made to JWV Post 619 are voluntary and non-refundable. No refunds will be
            given due to the nonprofit nature of JWV Post 619.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            are the property of JWV Post 619 or its licensors. You agree not to use, reproduce,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            controlled by JWV Post 619. We are not responsible for the content, privacy policies, or
            practices of any third-party websites or services. You acknowledge and agree that JWV
            Post 619 shall not be liable for any damages or loss caused by or in connection with
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our Services are provided on an “as is” and “as available” basis. JWV Post 619 makes no
            representations or warranties of any kind, express or implied, regarding the use or the
            results of our Services in terms of accuracy, reliability, or otherwise. Free For
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To the fullest extent permitted by law, JWV Post 619 shall not be liable for any
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You agree to indemnify, defend, and hold harmless JWV Post 619, its officers, directors,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Thank you for supporting JWV Post 619 and for complying with these Terms of Service.
          </p>
        </div>
      </div>
    </div>
