        ...
        <div>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
            ...
            <p className="text-sm text-[#666] mb-2">
              ...
              them off at any time using the cookie consent banner, and we will delete the cookies
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You can change your mind at any time: reopening the cookie consent banner lets you
            revise these choices, and withdrawing consent deletes the analytics and marketing
            cookies this site set.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            time through the consent banner — we delete the cookies when you do. Session recording
          ...
          <ul className="list-inside list-disc space-y-[4px] pb-[1em]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              <strong>Phone:</strong>{' '}
              <a href="tel:+17028844175" className="text-blue-600 hover:underline">
                (702) 884-4175
              </a>
            </li>
          </ul>
